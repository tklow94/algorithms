...
//Big O
    //It is O(nk), where n is the length of the array and k is the number of digits in the array which remains constant, but we cannot ignore becuase the number of digits in the number could be long!
